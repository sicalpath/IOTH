...
uint256 hashGenesisBlock("0x5dbc009c18b823822dfb037b717c4cdf7a2e43fd3b5f2a313c55a92272a59685");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5dbc009c18b823822dfb037b717c4cdf7a2e43fd3b5f2a313c55a92272a59685");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG; // a privkey for that 'vanity' pubkey would be interesting ;)
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512034972; //2794302151
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 515361;

        if (fTestNet)
        {
            block.nTime    = 1512034972;
            block.nNonce   = 515361;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa768162d9505939752f23bf923f7a19f9e2166e71c4fdf96b455b51dc06bcde0"));
        ...
        puts("block.nTime =");
        logPrint(block.nTime);
        puts("\n");
        puts("block.nNonce =");
        logPrint(block.nNonce);
        puts("\n");
        puts("block.GetHash =");
        puts(block.GetHash().ToString().c_str());
        puts("\n");
